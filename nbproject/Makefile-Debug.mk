...
${OBJECTDIR}/Consegne11122014Es2.o: Consegne11122014Es2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Consegne11122014Es2.o Consegne11122014Es2.c
...
${OBJECTDIR}/functionQueue.o: functionQueue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/functionQueue.o functionQueue.c
...
${OBJECTDIR}/heapSort.o: heapSort.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/heapSort.o heapSort.c

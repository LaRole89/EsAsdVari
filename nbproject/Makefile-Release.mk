...
${OBJECTDIR}/Consegne28102009Es1.o: Consegne28102009Es1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Consegne28102009Es1.o Consegne28102009Es1.c
...
${OBJECTDIR}/Consegne31102014Es1.o: Consegne31102014Es1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Consegne31102014Es1.o Consegne31102014Es1.c

${OBJECTDIR}/Consegne31102014Es2.o: Consegne31102014Es2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Consegne31102014Es2.o Consegne31102014Es2.c

${OBJECTDIR}/Consegne31102014Es3.o: Consegne31102014Es3.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Consegne31102014Es3.o Consegne31102014Es3.c

${OBJECTDIR}/Esame10092012Es1.o: Esame10092012Es1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Esame10092012Es1.o Esame10092012Es1.c

${OBJECTDIR}/Esame29052012Es2.o: Esame29052012Es2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Esame29052012Es2.o Esame29052012Es2.c

${OBJECTDIR}/Esame30052013Es2.o: Esame30052013Es2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Esame30052013Es2.o Esame30052013Es2.c
...
${OBJECTDIR}/margeSort.o: margeSort.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/margeSort.o margeSort.c
